...
export const CharacterModal: React.FC<CharacterModalProps> = ({
  ...
  useEffect(() => {
    ...
    setMulticlassEntries(existingCharacter?.multiclassEntries ?? []);
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
                        ...
                        <div>
                          ...
                          <NumberField
                            ...
                            max={20}
                            value={mc.level}
                            onChange={(v) => handleUpdateMulticlass(idx, { level: v })}
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1">
                            <NumberField
                              ...
                              onChange={(v) => handleUpdateMulticlass(idx, { abilityScore: v })}
                              className="w-full bg-[#14100e] border border-[#3d2e24] rounded-sm p-1.5 text-[#d4c5b3] text-center font-mono"
                            />
